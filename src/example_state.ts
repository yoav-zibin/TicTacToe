...
World.add(world, [
    // top-left
    Bodies.circle(30, 20, 25, {isStatic: true, render: <any>{fillStyle:'black'}}),
    // top-right
    Bodies.circle(380, 20, 25, {isStatic: true, render: <any>{fillStyle:'black'}}),
    // left
    ...
    // bottom-left
    Bodies.circle(30, 530, 25, {isStatic: true, render: <any>{fillStyle:'black'}}),
    // bottom-right
