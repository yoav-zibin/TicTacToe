  ...
  function getTranslations(): Translations {
    ...
    function handleDragEvent(type:string, clientX:number, clientY:number) {
      ...
      if (type === "touchend" || type === "touchcancel" || type === "touchleave") {
        ...
        setDraggingPieceTopLeft(getSquareTopLeft(draggingStartedRowCol.row,
                                                 draggingStartedRowCol.col)
                               );
    ...
    export let getBackgroundSrc = function(row:any, col:any) {
      if (isLight(row, col)) { return 'auto_resize_images/Chess-lightCell.svg'; }
      else { return 'auto_resize_images/Chess-darkCell.svg'; }
    };
